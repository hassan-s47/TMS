...
namespace TMS
{
    public partial class purchasevoucher : Form
    {
        ...
        void clear()
        {
            comboBox1.Text = "";
            s = new TMS.purchase();
            textBox1.Text = s.getpurchaseid().ToString();
        ...
        private void purchasevoucher_FormClosed(object sender, FormClosedEventArgs e)
        {
            if (!external)
            {
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            purchaseprint sp = new purchaseprint(ds);
            sp.Show();
